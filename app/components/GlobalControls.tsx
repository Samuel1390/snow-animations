...
export default function GlobalControls({ context }: Props) {
  ...
  return (
    <div
      className="flex overflow-x-auto sticky flex-wrap w-fit my-10 min-w-120 mx-auto justify-center
    ...
    >
      ...
      <div className="flex flex-col gap-2 justify-center">
        ...
        >
          {defaultProperties ? "Default" : "Custom"}
        </button>
      </div>
      <div className="flex flex-col justify-center gap-2">
        <label
    ...
    <>
      <div className="flex flex-col justify-center gap-1">
        ...
        <select
          ...
          className="[&>option]:dark:bg-gray-900 p-1 rounded cursor-pointer dark:bg-slate-700 text-black dark:text-white"
          id="sequence"
        >
      ...
      <div className="flex flex-col justify-center gap-1">
        ...
        <select
          className="dark:bg-slate-700 p-1 rounded cursor-pointer"
