  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex w-full my-6 justify-center">
        ...
        hover:bg-gray-400 hover:text-white hover:scale-105 dark:hover:text-sky-400 transition-all cursor-pointer 
        from-neutral-300 to-400 px-6
        dark:text-neutral-50 py-2"
        >
          View all animations
        </button>
      </div>
